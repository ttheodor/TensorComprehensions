 ...
 */
#include "tc/core/opencl/opencl_mapping_options_cpp_printer.h"

#include <sstream>

namespace tc {

OpenCLMappingOptionsCppPrinter& operator<<(
    OpenCLMappingOptionsCppPrinter& prn,
    const OpenCLMappingOptions& cudaOptions) {
