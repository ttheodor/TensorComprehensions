...
#include "tc/core/polyhedral/opencl/memory_promotion_heuristic.h"
#include "tc/core/polyhedral/opencl/tighten_launch_bounds.h"
...
std::tuple<std::string, tc::Grid, tc::Block> MappedScop::codegen(
  ...
  code << emitOpenCLKernel(specializedName, *mappedScopForCodegen) << std::endl;
